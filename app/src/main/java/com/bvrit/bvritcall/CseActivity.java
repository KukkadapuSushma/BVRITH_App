...
public class CseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contacts.add(new contact("Mr.Muralinath.RS", "7799852300"));
        contacts.add(new contact("Mr.K.Naresh", "9989803310"));
        contacts.add(new contact("Ms.P.Kavitha", "8790020724"));
        contacts.add(new contact("Mr.B.Sudheer Kumar", "7799999843"));
        ...
        contacts.add(new contact("Ms.G.Nagamani", "9581504231"));
        contacts.add(new contact("Mr.J.Sandeep", "9642611764"));
        contacts.add(new contact("Ms.K.Samata", "9866128760"));
        contacts.add(new contact("Mr.M.Dyva Sugnana Rao", "9603830970"));
        contacts.add(new contact("Ms.M.Shanmukhi", "9985161871"));
        contacts.add(new contact("Ms.M.Madhuri", "8008382718"));
        contacts.add(new contact("Ms.G.Padmavathi", "8088977999"));
        contacts.add(new contact("Ms.Parneet Kaur Vohra", "8886544436"));
